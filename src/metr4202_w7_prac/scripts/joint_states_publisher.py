...
class RobotArm:
    ...
    def init_pub_sub(self):
        ...
        self.sub = rospy.Subscriber(
            ...
            Pose,               # Message type
            self.invk_cb             # Callback function (required)
        )
        ...
        grip_sub = rospy.Subscriber(
            ...
            Float32,            # msg type
            self.gripper_cb          # callback function
        )
        # NOTE: gripper values 
        ...
        self.tag_tracker = rospy.Subscriber(
            'fiducial_transforms',
    ...
    def pickup_cube(self, cube: Cube):
        ...
        # grab box (1500 value)
        self.gripper_pub.publish(Float32(1250))
